     ...
     )
{
  ...
  pgb2->alpha_window_size = 1025; //1025
  ...
  //double alpha_ratio = pow(e, log(0.2965/epsilon)/N_step);
  //WARNING
  //double alpha_ratio = pow(0.2965/epsilon,1./N_step);
  double alpha_ratio = pow(0.35/epsilon,1./N_step);
          ...
          //for (int index_l = 7; index_l < 9; index_l++) {
            ...
            //for(int index_r = 0; index_r < pgb2->r_size; index_r++){
              ...
              //  printf("window[%d][%d] = %g\n", bin1, index_tau_first_polarq, selection[bin1][index_tau_first_polarq]);
                ...
                integrand = tau0*tau0*r_bins[bin1][bin2][index_alpha][index_r]*window_pair[bin1][bin2][index_alpha][index_r]
                                        *pgb2->Dl3[index_type_first][index_type_second][index_l][bin1][bin2][index_alpha][index_r];
